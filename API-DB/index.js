...
const SQLQueries = require("./src/SQLQueries").SQLQueries;

// Initialize PostgreSQL
const db = postgresqlManager(async (connection) => {
    await connection.query(
        "CREATE TABLE IF NOT EXISTS products (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, price INTEGET NOT NULL)"
    );
});
